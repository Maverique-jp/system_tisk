    ...
    <div class="py-12">
        ...
        <thead>
          <tr>
            ...
            <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">カテゴリー</th> <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100"><a href="{{ route('management.create') }}" class="bg-orange-500 hover:bg-blue-700 text-black font-bold py-2 px-4 rounded ">新規登録</a>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="border-t-2 border-gray-200 px-4 py-3">{{ $connects->category}}</td>
